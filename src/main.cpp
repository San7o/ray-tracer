...
int main(void)
{
  ...
  // -----------
  //
  // The framebuffer is the output of the raytracer. It is a 2D matrix
  // of pixels. It is also referred to as a "canvas".
  //
  // In this case the framebuffer and the output image are the same
  // thing.
